...
export default function Tweet({
  ...
  return (
    <div className="tweet m-auto w-3/4 rounded-lg border border-gray-200 dark:border-gray-800 px-6 py-4 my-10 w-full bg-white dark:bg-gray-900">
      ...
      <div className="flex !text-gray-700 dark:!text-gray-300 mt-2">
        ...
        >
          ...
          <span>{Number(public_metrics.reply_count).toLocaleString('en', { notation: 'compact' })}</span>
        </a>
        <a
        ...
        >
          ...
          <span>{Number(public_metrics.like_count).toLocaleString('en', { notation: 'compact' })}</span>
        </a>
      </div>
    </div>
  );
