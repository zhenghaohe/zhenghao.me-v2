...
The answer is no - there will be no duplicate strings allocated. You can easily verify this by adding `const anotherString  = bigString` in the script above and check to see if the heap memory used increases or not. 
