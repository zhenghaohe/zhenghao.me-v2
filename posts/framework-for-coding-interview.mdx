...
> YMMV some companies'/teams' interview loops don't evaluate role fit and some do. That means you could get web-oriented interview loops for frontend web candidates sometimes. Try talk to your recruiter about it beforehand.
