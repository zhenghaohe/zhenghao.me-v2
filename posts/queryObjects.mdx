...
In this post I want to show you how we can leverage a lesser-known API called `queryObjects` to understand and detect memory leaks in Chrome from the DevTools Console. 
