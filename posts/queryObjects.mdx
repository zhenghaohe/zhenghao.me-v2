...
> These examples are derived from [*A surprising JavaScript memory leak found at Meteor*](http://point.davidglasser.net/2013/06/27/surprising-javascript-memory-leak.html).
