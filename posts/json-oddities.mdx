...
```
> Checkout [safe-stable-stringify](https://www.npmjs.com/package/safe-stable-stringify), an safer alternative to `JSON.stringify`, which gracefully handles cyclic objects and `bigint`.
