...
I just wanted to write a quick post on how to work with dates in different formats more easily with a relatively new featured in ES2018 called Regex Named Capture Groups.
