...
![alt](/art/blog/javascript-variables/cppLineExample.jpg)
...
![alt](/art/blog/javascript-variables/cppLineExample2.jpg)
...
![alt](/art/blog/javascript-variables/JSLineExample1.jpg)
...
![alt](/art/blog/javascript-variables/JSLineExample2.jpg)
...
![alt](/art/blog/javascript-variables/JSPrimitiveExample1.jpg)

> Using object literals always gives you new, **unique** objects, while primitive values (except for numbers, they are comlicated) are **reused**. That means with `const a = 'foo'; const b = 'foo'`, we only have one string `foo` stored in the memory at runtime due to [string interning](https://en.wikipedia.org/wiki/String_interning). This might seem strange to you at first, and if you need proof, please take a look at [my post]() on the topic of the memory model in V8.
...
![alt](/art/blog/javascript-variables/whatspecsays.jpg)
...
![alt](/art/blog/javascript-variables/JSTableExample1.jpg)
...
![alt](/art/blog/javascript-variables/JSTableExample2.jpg)
...
![alt](/art/blog/javascript-variables/letvsconst.jpg)
...
![alt](/art/blog/javascript-variables/hiddenLayerInJS.jpg)
...
![alt](/art/blog/javascript-variables/smiExample.jpg)
...
![alt](/art/blog/javascript-variables/jsPassbyreference.jpg)
...
![alt](/art/blog/javascript-variables/passbyvalueExample.jpg)
