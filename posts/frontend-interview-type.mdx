...
> Another way to prepare for your frontend interviews is to use the platform [GreatFrontEnd](https://www.greatfrontend.com?fpr=zhenghao16). It has real-world interview questions along with in-depth solutions, written and review by me. It even covers frontend system design interview questions! Use coupon code `ZHENGHAO` to get 25% discount!
