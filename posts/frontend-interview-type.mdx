---
title: Two types of frontend coding interviews
published: true
listed: true
date: '12/30/2022'
tags: interview
...
3. API ergonomics for better developer experience
...
To become better at the UI-building questions, practicing quick prototyping small UI widgets helps. Candidates with apathy towards diving deep in HTML and CSS topics tend to fail catastrophically, so refamiliarize yourself with fundamentals like the box model and browser event system.
...
- Christoph Nakazawa put out an interesting post called [Frontend Engineer Archetypes](https://cpojer.net/posts/frontend-engineering-archetypes), where he outline the various types of frontend archetypes. I think that echoes some of the themes I raised in my post.