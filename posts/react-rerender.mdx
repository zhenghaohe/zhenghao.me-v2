---
title: Understand when React renders your component from the inside
published: true
listed: true
date: '03/18/2022'
tags: react
...
There are two ways that your component can proactively make changes to its own state to schedule updates via:
...
There are many other techniques you can employ to optimize context consumption. Vladimir has a [great post](https://thoughtspile.github.io/2021/10/04/react-context-dangers/) on this that you should check out.
