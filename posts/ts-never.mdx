...
<details>
    ...
    <p>In my previous post I mentioned how you can create declare “local (type) variable” together with `extends infer`. Check it out [here]() if you haven’t seen it.</p>
</details>
