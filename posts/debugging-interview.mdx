...
Transcribing is about converting your thoughts or solutions to executable code.
...
With this newfound knowledge, it is not hard to tell what exactly the current standard interview process lacks. Activities such as searching and comprehension are completely left out and you have no way to prove your competence competencies needed for a big part of a software engineer job.
...
When one is debugging, they engage in **all five activities**. It entails a sequence of searching, comprehension, exploration and writing code. And it is incredibly revealing to watch one debug: 
    ...
    2. how are they navigating their way through the codebase, forming different hypotheses about the bug?
