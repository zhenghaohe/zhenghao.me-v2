...
> A more accurate name for the idea of “type variables” is type synonyms or type alias. I use the word "type variables" to draw an analogy to how a JavaScript variable references a value. 
>
...
<details>
    <summary>`infer` is useful for caching some intermediate types</summary>
...
<details>
    <summary>Though this is not a perfect analogy...</summary>
